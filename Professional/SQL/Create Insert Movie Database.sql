...
(
    ...
    D_City      VARCHAR2(70)    NOT NULL,
    D_State     VARCHAR2(2)     NOT NULL,
    D_zip       VARCHAR2(20)    NOT NULL,
...
insert into director (did, d_name, d_address , d_city , d_state , d_zip, d_phone) 
values ('D1', 'Rick', '123 Street Drive', 'Austin', 'TX', '84394', '111-111-1111');

insert into director (did, d_name, d_address , d_city , d_state , d_zip, d_phone) 
values ('D2', 'Susan', '234 Drive Avenue', 'Austin', 'TX', '47938', '222-222-2222');

insert into director (did, d_name, d_address , d_city , d_state , d_zip, d_phone) 
values ('D3', 'James', '345 Avenue Lane', 'Austin', 'TX', '33952', '333-333-3333');

insert into director (did, d_name, d_address , d_city , d_state , d_zip, d_phone) 
values ('D4', 'Michael', '456 Lane Street', 'Austin', 'TX', '39482', '444-444-4444');

commit;

insert into book 
values ('tt0123456','Runaway','D3','15-Dec-17','IT',3.56,'NULL');

insert into book 
values('tt0123342','Comeback','D3','17-Jan-15','IT',20.23,'NULL');
